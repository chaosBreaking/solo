...
export default observer(function ProfileDialog({ onClose }) {
    useStyles(s);
    ...
    return <Backdrop open={true} onClose={handleClose} style={{ zIndex: 1 }}>
        <div className={cs(s.dialog, {
            ...
            />
            <DialogActions>
                {!submitting && <Button onClick={handleClose} style={{ marginRight: '.1rem' }}>
                    取消
                </Button>}
